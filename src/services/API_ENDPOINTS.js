...
const SCREENSHOT_LIST = "screenshot/list";
const SCREENSHOT_UPLOAD = "screenshot/upload";


// Exporting all variables at once
export {
    AUTH_LOGIN, AUTH_SIGNUP, LOGIN_WITH_GOOGLE,
    PROFILE, CHECK_USER_NAME_EXISTS, ME,
    ...
    USERS, IMAGE_UPLOAD, GET_LAST_LOG, GET_CREATE_LOG, SCREENSHOT_LIST, SCREENSHOT_UPLOAD
};